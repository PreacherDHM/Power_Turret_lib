...
public class Turret {
    ...
    *<p>
    * By setting the targeting solution it will allow one to swich TargetingSolutions.
    *</p>
    *<p><b> Idle </b> Idle runs the turret at a constant power <b>(0.05) </b>.</p>
    *<p><b> Rotation </b> Rotation allows the turret to be controled by spesifying an Radion object.</p>
    *<p><b> Position </b> Position allows the turret to be controled by spesifying a Vector2.</p>
    *<p><b> TargetingSystem </b> TargetingSystem alows the turret to be controled by a TargetingSystem object.</p>
    ...
    **/
     ...
     *
     * <p><b> Idle </b> just spins at a conston rate of 5% power.</p>
     * <p><b> Rotation </b> allows the turret to rotate to a spesified angle.</p>
     * <p><b> Position </b> allows the turret to keep the turret pointed toward a position that is spesified</p>
     * <p><b> TargetingSystem </b> allows the turret to use Algorithms to offset the m_targetPosition so that it's on point every shot</p>
     * */
    public void Update() {
